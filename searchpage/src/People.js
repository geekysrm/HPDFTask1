    ...
    <Card style={{ width: '243px',height:'218px', marginLeft: '135px', marginTop: '10px',display:'inline-block',float:'left'}}>
        ...
        <CardHeader
            ...
            <FlatButton label="Follow" labelStyle={{ paddingBottom: '20px', textAlign: 'center', textTransform: 'capitalize', fontSize: 9, fontWeight: 700 }} style={button} />
                ...
                <span style={{fontSize:'11px',float:'left',paddingLeft:10}}> Official Twitter account of the Unique Identification Authority of India. RTs are not endorsements</span>
                <span style={{ fontSize: '10px', float: 'left', paddingLeft: 10, paddingTop: 7, color: '#657786' }}>Followed by <span style={{ color: '#1da1f2' }}><a>PMO India</a></span > and <span style={{ color: '#1da1f2' }}><a>4 others</a></span></span>
        </div>
    </Card>
        <Card style={{ width: '243px', height: '218px', marginLeft: '12px', marginTop: '10px', display: 'inline-block', float: 'left' }}>
            ...
            <div style={{ paddingTop: 90 }}>
                ...
                <FlatButton label="Follow" labelStyle={{ paddingBottom: '20px', textAlign: 'center', textTransform: 'capitalize', fontSize: 9, fontWeight: 700 }} style={{float: 'left',
                    marginLeft: '120px',
                    marginTop: '-60px',
                    borderRadius: 20,
                    borderStyle: 'solid',
                ...
                <span style={{ fontSize: '11px', float: 'left', paddingLeft: 10 }}>Co-founder of <span style={{ color: '#1DA1F2', cursor: 'pointer' }}> <a>@Infosys</a></span>. Worked on<span style={{ color: '#1DA1F2', cursor: 'pointer' }}> <a>#Aadhaar</a></span>.Co-author of <span style={{ color: '#1DA1F2', cursor: 'pointer' }}><a>@RebootingIndia</a></span>.</span>
                <span style={{ fontSize: '10px', float: 'left', paddingLeft: 10, paddingTop: 7, color: '#657786' }}>Followed by <span style={{ color: '#1da1f2' }}><a>Phonepe</a></span ></span>
            </div>
        </Card>
    </div>
);
